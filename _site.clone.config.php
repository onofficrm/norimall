...
return array(
    ...
    'local_areas' => array(
        ...
        array(
            'slug' => 'yangpyeong-clean',
            'name' => '양평구',
            'label' => '양평구하수구청소',
            'url' => '/page/yangpyeong-clean.php',
            'blurb' => '양평구(양평군 생활권) 하수구·싱크대·배수구 청소를 전화로 상담합니다. 경기광주 인근 출동 가능 여부를 빠르게 안내합니다.',
        ),
        array(
            'slug' => 'yangpyeong-clog',
            'name' => '양평구 막힘',
            'label' => '양평구하수구막힘',
            'url' => '/page/yangpyeong-clog.php',
            'blurb' => '양평구 하수구·싱크대·변기 막힘·역류 증상을 전화로 확인하고 필요한 점검·출동을 안내합니다.',
        ),
    ),
    'area_spots' => array(
        '광주역 인근', '태전역 인근', '초월역 인근', '곤지암역 인근',
        '오포 고산', '경안 중심', '광남 대단지', '신현·능평', '양평구 인근',
    ),
